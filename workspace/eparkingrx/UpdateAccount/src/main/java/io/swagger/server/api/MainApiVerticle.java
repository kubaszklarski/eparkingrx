...
public class MainApiVerticle extends AbstractVerticle {
    ...
    public void deployVerticles(Future<Void> startFuture) {
        ...
        vertx.deployVerticle("io.swagger.server.api.verticle.UpdateAccountApiVerticle", res -> {
            if (res.succeeded()) {
                LOGGER.info("UpdateAccountApiVerticle : Deployed");
            } else {
                startFuture.fail(res.cause());
                LOGGER.error("UpdateAccountApiVerticle : Deployment failed");
            }
        });
